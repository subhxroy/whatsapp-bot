                    ...
                    <td className="px-6 py-4 text-right space-x-2">
                      ...
                      {req.status === 'APPROVED' && (
                        <button
                          onClick={() => handleReject(req.id)}
                          disabled={actionId === req.id}
                          className="inline-flex items-center gap-1.5 rounded-full bg-[#fc5000]/15 border border-[#fc5000] px-4 py-2 text-xs font-bold text-[#fc5000] transition hover:bg-[#fc5000] hover:text-[#070607] disabled:opacity-50"
                          title="Revoke user access and disconnect WhatsApp bot"
                        >
                      ...
                      {req.status === 'REJECTED' && (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-full bg-[#fc5000] px-4 py-2 text-xs font-bold text-[#070607] transition hover:bg-[#070607] hover:text-[#ffffff] disabled:opacity-50"
                        >
                          <Check className="h-3.5 w-3.5" /> Re-Approve Access
                        </button>
                      )}
                    </td>
                  </tr>
